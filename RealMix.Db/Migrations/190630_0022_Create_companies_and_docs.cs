        ...
        public override void Up()
        {
            ...
            Create.Table(DbConstants.CompanyDocumentTableName)
                ...
                .WithColumn("companyid").AsInt32()
                    .ForeignKey($"fk_{DbConstants.CompanyDocumentTableName}_{DbConstants.CompanyTableName}", DbConstants.CompanyTableName, "id")
                .WithColumn("documentid").AsInt32()
                    .ForeignKey($"fk_{DbConstants.CompanyDocumentTableName}_{DbConstants.DocumentTableName}", DbConstants.DocumentTableName, "id");
        }
