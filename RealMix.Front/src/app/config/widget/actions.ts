...
export const getPageAsync = createAsyncAction(AsyncActions.CONFIG_WIDGET_GETPAGEASYNC,
...
export const getItemAsync = createAsyncAction(AsyncActions.CONFIG_WIDGET_GETITEMASYNC,
...
export const saveAsync = createAsyncAction(AsyncActions.CONFIG_WIDGET_SAVEASYNC,
