  ...
  ({ type = 'text', data, field, onChange, placeholder, v, size, key, children }) => {
    ...
    return (
      <div className="form-group">
        ...
        <input type={type} className={classNames('form-control', { 'is-invalid': message })} id={`${field}${key}`} placeholder={placeholder}
          onChange={e => onChange(field, e.target.value)} value={value} />
